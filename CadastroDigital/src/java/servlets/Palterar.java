 ...
 * @author matheus
 */
@WebServlet(name = "Palterar", urlPatterns = {"/Palterar"})
public class Palterar extends HttpServlet {
	...
	RequestDispatcher view = request.getRequestDispatcher("alterarP.jsp");
